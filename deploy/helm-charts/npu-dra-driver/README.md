...
| `npu.ocloud.edge.example.com.whole`         | `deviceClass.subClasses.whole`      | `... && device.attributes["npu.huawei.com/slice_strategy"].string == "FixedTemplate"`         |
| `npu.ocloud.edge.example.com.dynamic`       | `deviceClass.subClasses.dynamic`    | `... && device.attributes["npu.huawei.com/slice_strategy"].string == "Dynamic"`               |
