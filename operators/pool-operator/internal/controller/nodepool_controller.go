...
// Phase 3 scaffolding: empty Reconcile body. Business logic lands in P3-T-004.
...
// Reconcile is the no-op shell. P3-T-004 will replace this with the
// NodePool node selection + status roll-up logic per docs/phase3-plan.md §3.
func (r *NodePoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	// TODO(P3-T-004): implement NodePool Reconcile (node selector match, status roll-up)
	_ = ctx
	_ = req
...
// primary resource only. Secondary watches are added in P3-T-004.
